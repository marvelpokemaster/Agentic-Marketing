  ...
  return (
    <div className="mx-auto max-w-md py-20 relative z-10 text-center">
      <Card className="space-y-6">
        <div className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-rose-500/10 border border-rose-500/30 text-rose-400 mx-auto">
          <AlertCircle className="h-6 w-6" />
        </div>

        <div className="space-y-2">
          <span className="font-mono text-xs font-bold text-rose-400 uppercase tracking-widest block">
            404 — TELEMETRY_NOT_FOUND
          </span>
          <h1 className="font-heading text-2xl font-bold text-slate-100">
            Node or Resource Missing
          </h1>
          <p className="font-sans text-xs text-muted/70 leading-relaxed max-w-xs mx-auto">
