  ...
  return (
    <Card className="flex flex-col justify-between space-y-3">
      <div className="flex items-center justify-between">
        <span className="font-mono text-[11px] font-semibold tracking-wider uppercase text-muted/70">
          {label}
        </span>
      ...
      <div>
        <div className="flex items-baseline justify-between gap-2">
          <motion.h4
            ...
            className="font-heading text-2xl font-bold text-slate-100"
          >
            {value}
          </motion.h4>
          {badge}
        ...
        {(subtext || trend) && (
          <p className="mt-1 font-sans text-xs text-muted/80 flex items-center gap-1.5">
